...
class Address {
    public createAddress() {
        try {
            ...
            const fs = require('fs')
            const data = fs.readFileSync('/home/user/Desktop/typeScriptPrograms/JSON_Files/addressBook.json');
            const addressb = JSON.parse(data);
            const nameRestriction = /[a-z]/ig;
            const contactRestriction = /[0-9]/g;
    ...
    */
    ...
    public openProfile(): false | string[] {
        try {
            var read = require('readline-sync')
            const fs = require('fs')
            const data = fs.readFileSync('/home/user/Desktop/typeScriptPrograms/JSON_Files/addressBook.json');
...
export class Address2 extends Address {
    addressFunction(): Boolean {
        var read = require('readline-sync')
        var add = new Address();
        /*
